	...
	<div class="container">
	    <?php
	       ...
	       if( have_posts() ) : while ( have_posts() ) : the_post();
			   ...
			   $project_logo = rwmb_meta('ptf_project_client_logo');
			   ...
			   $project_ColorclientLogo = rwmb_meta('ptf_project_color_client_logo');
				    ...
				    <?php if ( !empty( $project_images )) : ?>
        				...
        				<?php foreach ( $project_images as $project_image ) : ?>
                    		...
                    		<?php if ( $i === 0 ) : ?>
                				...
                				<?php $project_image_thumb = aq_resize( $project_image['full_url'] , true, true, true ); ?>
                				<div class="col-sm-12">

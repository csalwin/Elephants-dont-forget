        ...
        function register_meta_boxes( $meta_boxes ) {
            ...
            $meta_boxes[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'name'             => __( 'White Client Logo', 'artcore-addons'),
                        'desc'             => __('Upload the image to be used for the hover over client logo. <strong>Only one allowed.</strong>', 'artcore-addons'),
                        'id'               => $prefix . 'project_client_logo',
                        'type'             => 'image',
                        'max_file_uploads' => 1,
                    ),
                    array(
                        'name'             => __( 'Colour Client Logo', 'artcore-addons'),
                        'desc'             => __('Upload the image to be used for the mian client logo. <strong>Only one allowed.</strong>', 'artcore-addons'),
                        'id'               => $prefix . 'project_color_client_logo',
                        'type'             => 'image',
                        'max_file_uploads' => 1,
                    ),
                    array(
